...
async function register(settings, versionAssets, versionRowKey) {
  ...
  const entity = {
    ...
    Scripts: azure.generator.String(JSON.stringify(assetsWithoutContent.scripts)),
  ...
  if (assetsWithoutContent.styleSheets.length) {
    entity.StyleSheets = azure.generator.String(JSON.stringify(assetsWithoutContent.styleSheets));
  }
