...
- Updated the `deploy` command to always record the explicit version and not update the major version for pre-releases.  [#47](https://github.com/blackbaud/skyux-deploy/pull/47)
